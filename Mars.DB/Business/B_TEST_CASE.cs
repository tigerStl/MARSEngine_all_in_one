    ...
    public class B_TEST_CASE : T_TEST_CASE_SUMMARYDTO
    {
        ...
        public static List<long?> GetAssignedApplications(string strDBIdx, long testCaseId, MarsEntities objDbCntx = null)
        {
            ...
            try
            {
                ...
                {
                    MarsEntities marsEntities = objDbCntx ?? Mars.message.DataLayer.BoHelper.GetMarsEntitiesInstance(strCurrentDB: strDBIdx);
        ...
        {
            MarsEntities marsEntities = dbCntxt == null ? Mars.message.DataLayer.BoHelper.GetMarsEntitiesInstance(strCurrentDB:strDBIdx) : dbCntxt;
        ...
        {
            MarsEntities marsEntities = dbCntx ?? Mars.message.DataLayer.BoHelper.GetMarsEntitiesInstance(strCurrentDB:strDBIdx);
            var testCase = (from c in marsEntities.T_TEST_CASE_SUMMARY
            ...
            int iSaveOption, ref string strError)
        {
            ...
            //        {
            //            marsEntities = null;
            //            MessageBox.Show("Error saving test case", "Test case SaveAs", MessageBoxButton.OK, MessageBoxImage.Warnning);
            //            return false;
            //        }
        ...
        public bool DeleteTestCaseById(string strDBIdx, long lTestId, ref string strError)
        {
            ...
            //        {
            //            marsEntities = null;
            //            System.Windows.MessageBox.Show("Error deleting Test Case", "Test Case Delete", MessageBoxButton.OK, MessageBoxImage.Warnning);
            //            return false;
            //        }
