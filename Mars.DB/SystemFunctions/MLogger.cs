...
namespace Route2NSEx.src.Marquis.systemUtil
{
    internal class MLogger
    {
        ...
        /// Mars.DB
        /// </summary>
        private const string LOGGER_NAME = "TestService";
        ...
        public void logBegin(string strMethodName,string strInfo=null)
        {
#if !_tigerHintLog
            //mobjLog.Info(string.Format("[INFO] {0:MM/dd/yyyy H:mm:ss zzz} {1}.{2} begins...", DateTime.Now, mstrCurrentClassName, strMethodName));
            mobjLog.Info(string.Format("[INFO] {0}.{1} begins...{2}", mstrCurrentClassName, strMethodName,strInfo==null?"":strInfo));
#endif
        }
