...
import com.demo.loaniq.ui.panels.SettingsPanel;
...
extends JFrame {
    ...
    public MainFrame() {
        ...
        this.settingsPanel.setName("LIQ_SETTINGS_NOTEBOOK");
    ...
    private JMenuBar buildMenuBar() {
        ...
        settingsItem.setName("LIQ_MENU_OPTIONS_SETTINGS");
        settingsItem.addActionListener(e -> this.tabbedPane.setSelectedComponent(this.settingsPanel));
    ...
    private JScrollPane buildTreePanel() {
        ...
        t.addMouseListener(new MouseAdapter() {
            ...
            private void showTreePopup(MouseEvent mouseEvent) {
                TreePath treePath = t.getPathForLocation(mouseEvent.getX(), mouseEvent.getY());
                if (treePath == null) {
                    return;
                }
                t.setSelectionPath(treePath);
                JPopupMenu jPopupMenu = new JPopupMenu();
                JMenuItem jMenuItem = new JMenuItem("Open");
                jMenuItem.addActionListener(actionEvent -> MainFrame.this.onTreeSelection());
                JMenuItem jMenuItem2 = new JMenuItem("Approve");
                jMenuItem2.addActionListener(actionEvent -> MainFrame.this.doApproveCurrent());
                JMenuItem jMenuItem3 = new JMenuItem("Release");
                jMenuItem3.addActionListener(actionEvent -> MainFrame.this.doReleaseCurrent());
                jPopupMenu.add(jMenuItem);
                jPopupMenu.add(jMenuItem2);
                jPopupMenu.add(jMenuItem3);
                jPopupMenu.show(t, mouseEvent.getX(), mouseEvent.getY());
            }
        });
