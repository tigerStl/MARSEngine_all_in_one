...
namespace DataTableCompare
{
    public class CompareResult
    {
        ...
        internal void Init(string[] allFieldNames, string[] showFieldNames, string[] keyFieldNames)
        {
            ...
            SummaryDataTable.Columns.Add("Type of Difference", typeof(String));
            SummaryDataTable.Columns.Add("Reason for Difference", typeof(String));
            SummaryDataTable.Columns.Add("Notes", typeof(String));
            ...
            ResultDataTable.Columns.Add("Type of Difference", typeof(String));
            ResultDataTable.Columns.Add("Reason for Difference", typeof(String));
            ResultDataTable.Columns.Add("Notes", typeof(String));
            ...
            if (lineItem.ErrorStatus == CompareErrorLineItem.Status.NotEqual)
            {
                foreach (int colNum in lineItem.ErrorColumns)
                {
                    ...
                    try
                    {
                        ...
                        {
                            drSummary["Diff"] = " " + Math.Round(leftValue - rightValue, 7);
                        }
                        else
                            drSummary["Diff"] = " ";
                    }
