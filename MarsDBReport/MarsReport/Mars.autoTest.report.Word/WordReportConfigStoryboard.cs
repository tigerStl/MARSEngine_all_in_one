...
namespace Mars.autoTest.report.Word
{
    public class WordReportConfigStoryboard
    {
        ...
        public void InitStoryBoardData()
        {
            ...
            StoryBoardData.Columns.Add("Data_Set_Descr");
        ...
        public void AddRowToStoryBoardData(string runOrder, string testCaseName, string tsName, string dataSet, string dataSetDescr, string result, string bStart, string bDuration, string cStart, string cDuration)
        {
            ...
            newDTRow["Data_Set_Descr"] = dataSetDescr;
