...
namespace Mars.TestFramework.DataCompare
{
    class XmlCompareReport
    {
        ...
        //data for PT
        private XmlCompareProcessorOld xcp;
        ...
        public XmlCompareReport(XmlCompareResult xcr, XmlCompareReportConfig xcrc, DataTable PopulatedDataTable, XmlCompareProcessorOld xcp, XmlCompareConfig xcc)
        {
            // TODO: Complete member initialization
            this.xcr = xcr;
            this.xcrc = xcrc;
        ...
        internal string  ProcessReport(string excelFileName)
        {
            Logger.Info("ProcessReport", "Begin");
            ...
            Logger.Info("ProcessReport", "End");

            return xlfilepath;
        }

        public static void DisplayExcel(string excelFileName)
        {
            var xlApp = new Excel.Application();
            xlApp.Visible = true;
