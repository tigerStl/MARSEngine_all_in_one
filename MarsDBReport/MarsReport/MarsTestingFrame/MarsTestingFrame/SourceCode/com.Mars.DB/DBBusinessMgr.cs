...
namespace MarsTestFrame.SourceCode.com.Mars.DB
{
    ...
    public class DBBusinessMgr
    {
        ...
        public List<V_OBJECT_APPSDTO> GetAppObjectsByAppShortName(string strAppShortName)
        {
            ...
            return objApps.GetAppObjectsByAppShortName("TEMPSTUB",strAppShortName);
        ...
        internal List<T_TEST_PROJECTDTO> GetProjects()
        {
            ...
            MarsDataAccessLayer<T_TEST_PROJECT> objDBAccess = new MarsDataAccessLayer<T_TEST_PROJECT>("TEMPSTUB");
