...
namespace MarsTestFrame.com.Mars.TestConfigObjects
{
    ...
    internal class TestCaseData: TCDataFile
    {
        ...
        {
            return GetDataFromDatabaseByStoryBoardAssigned();
        }
        ...
        private ERROR_CODE GetDataFromDatabaseByStoryBoardAssigned()
        {
            ...
            currentDataSummary = BoHelper.GetDataSummaryByStoryBoardIdTestCaseIDRunorder("TEMPSTUB",TestStoryBoardRef.STORYBOARD_DETAIL_ID, TestStoryBoardRef.TEST_CASE_ID, TestStoryBoardRef.RUN_ORDER);
            ...
            else
            {
                ...
                try
                {
                    dataWithObjectNameList = BoHelper.GetAssignedTestDataByTestCaseID("TEMPSTUB",TestStoryBoardRef.TEST_CASE_ID, currentDataSummary.DATA_SUMMARY_ID);
        ...
        public TestCaseData(V_STORYBOARD_TEST_FULLVISIONDTO objStoryBoardRef):base()
        {
