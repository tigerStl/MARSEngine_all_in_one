...
namespace MarsTestFrame.SourceCode.com.Mars.KeyWords
{
    public class KeyWordsMainEntry
    {
        ...
        public Hashtable getAllKeyWords()
        {
            ...
            mhstAllKeywords=objKeyWordsLoader.LoadKeywords();

            return mhstAllKeywords ;
        }

        public static Hashtable GetAllKeyWords()
        {
            Logger.logBegin("GetAllKeyWords");
            KeyWordsMainEntry objInstance = GetInstance();
            Hashtable hstResult = objInstance.getAllKeyWords();
            Logger.logEnd("GetAllKeyWords");
            return hstResult;
        }

        public KeyWordObjectInfo GetKeyWordFunctionByName(string strKeywordName)
        {
