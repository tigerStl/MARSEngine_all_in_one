...
namespace MARS.TEMP
{
    class ExcelUtil
    {
        ...
        public static void ExportXmlCompareResultToExcel(XmlCompareResult xcr, XmlCompareReportConfig xcrc, DataTable DiffTableVal, string filePath, XmlCompareProcessor xcp, XmlCompareConfig xcc)
        {
