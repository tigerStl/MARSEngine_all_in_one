...
namespace Mars.Report
{
    ...
    class TestStoryboardPieData : MarsPieGraphEnhance
    {
        private static MLogger Logger = MLogger.GetLogger(typeof(TestStoryboardPieData));
        ...
        public MarsRptGraphType GetGrphType()
        {
            return MarsRptGraphType.en_Pie;
        }
    ...
    class TestStepsReportGridData : ReportGridDataInterface, MarsPieGraphEnhance, ReportGridDataMasterInterface
    {
    ...
    class TestStoryBoardSummayGridData : ReportGridDataInterface
    {
        ...
        public TestStoryBoardSummayGridData(long currentStoryBoardId,string strDBIdx)
        {
        ...
        public bool BeginFetchRows()
        {
            ...
            currentStoryBoardInfo = B_V_STORYBOARD_TEST_FULLVISION.GetStoryBoards(this.currentStoryBoardId, currentDBIdx);
            /// sorted
