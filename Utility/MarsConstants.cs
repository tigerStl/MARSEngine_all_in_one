namespace Mars.message.Utility
{
    public class MarsConstants
    {
        ...
        public const string cnst_pegProperty_hwnd_fromuiaa = "_FromUIAAHwnd";
    }

    public class MarsGlobarVar
    {
        public static string UUID_FROM_WEB { get; set; }
        public static string Update_testResultURL { get; set; }
        public static string MARS_WEB_HOST { get; set; }// MARS web 
        public static string MARS_WEB_STORYSTATUS_CALLBACK { get; set; }
        public static string MARS_CURRENT_DB {
            get;
            set;
        }
        public static string MARS_current_StoryboardId { get; set; }
    }
