...
namespace TestFlowClient.BreakPoints
{
    ...
    {   
        ...
        public bool EqualTo(TestBreakPoints objTarget)
        {
            return (StepRunMark == objTarget.StepRunMark)
                && (string.Compare(TestSuiteName, objTarget.TestSuiteName, true) == 0)
    ...
    {
        [OperationContract]
        void AddOneBreakPoint(TestBreakPoints objBreakPnt);
        [OperationContract]
        void DebugStepOver(TestBreakPoints objBreakPnt);
        [OperationContract]
