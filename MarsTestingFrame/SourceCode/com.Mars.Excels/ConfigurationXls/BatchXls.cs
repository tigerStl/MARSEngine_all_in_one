...
#if _Datafrom_Database
                    TCObjects objTC = CreateTCObjectByTS("__DEFAULT__",objTestSuit);
#else
...
#if _Datafrom_Database
        protected virtual TCObjects CreateTCObjectByTS(string strDBIdx,BatchConfigObject objTestSuit)
        {
            TCObjects objTC = new TCObjects();
            objTC.XlsFileNameWithPath = objTestSuit.TCFilePath;
            objTC.CurrentRunName = objTestSuit.TCSheetName;
