...
namespace MarsTestFrame.SourceCode.com.Mars.Excels.DB
{
    public class DashBoardFromDB : BatchXls
    {
        ...
        protected override TCObjects CreateTCObjectByTS(string strDBIdx,BatchConfigObject objTestSuite)
        {
            if (objTestSuite is BatchConfigObjectFromDB)
            {
                TCObjects4DB objDBObj = new TCObjects4DB(strDBIdx);
                ...
                return base.CreateTCObjectByTS(strDBIdx,objTestSuite);
        }
    ...
    public class TCObjects4DB: TCObjects
    {
...
#endif
        private string currrentDBIdx = "MarsEntities";
        public TCObjects4DB(string strDBIdx) : base()
        {
        ...
        protected void LoadTestSteps()
        {
            ...
            TestCaseData objTestCaseData = new TestCaseData(currrentDBIdx,((BatchConfigObjectFromDB)AssignedStoryBoardInfo).AssignedStoryObject);
