...
namespace MarsTestFrame.SourceCode.com.Mars.Excels
{
    ...
    public class DashBoardFactory
    {
        ...
        public static List<MarsKeyValues<string, string>> RefreshProjectsWithApps(string strDBIdx, long projectId=int.MinValue,long storyboardId=int.MinValue)
        {
            try
            {
                IList<V_STB_PROJ_APP_FULLVISIONDTO> lstProj = null;
                if (storyboardId == int.MinValue)
                    lstProj = BoHelper.GetStoryBoardById(strDBIdx,null);
                else
                    lstProj = BoHelper.GetStoryBoardById(strDBIdx, storyboardId);
