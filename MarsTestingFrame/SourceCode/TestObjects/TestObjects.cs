...
namespace com.Mars.TestFrame.TestObjects
{
    ...
    public sealed class TestObjectsManagement
    {
        ...
        public static ConfigObjectBase GetObjectInfomationByPegwindow(
            string strDBIdx,
            string strAppShortName, string strPegWindowName, string strObjectName)
        {
            ...
            List<TestPegwindowObject> lstObjects = GetPegwindowsByValues(
                strDBIdx,
                strPegWindowName, strAppShortName);
            if (lstObjects==null)
            {
        ...
        public static List<TestPegwindowObject> GetPegwindowsByValues(string strDBIdx, string strPegWindowActionValueSrc, string strAppShortName)
        {
            ...
            try
            {
                ...
                if (objInstance.meCurrentFrom == TestObjectSource.TOS_Not_Init)
                {
                    ...
                    bool bLoad = objTestObjectAdp.LoadTestObjects(strDBIdx,strAppShortName);
                    if (bLoad)
                    {
