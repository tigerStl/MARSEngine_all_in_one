...
namespace MARS.WebAutomation.UI
{
    public partial class MainWorkbenchForm
    {
        ...
        private void ApplyLocalizedUi()
        {
            ...
            menuFileLoad.Text = L("Load");
            menuFileClear.Text = L("Clear");
            ...
            if (_tabApiPerformance != null)
                _tabApiPerformance.Text = L("ApiPerformanceTesting");
            ...
            if (_lblApiPerfHint != null)
                _lblApiPerfHint.Text = L("ApiPerformanceHint");
            if (_btnApiPerfRun != null)
                _btnApiPerfRun.Text = L("ApiPerfRun");
            if (_btnApiPerfConfig != null)
                _btnApiPerfConfig.Text = L("ApiPerfConfig");
            if (_btnApiPerfExport != null)
                _btnApiPerfExport.Text = L("ApiPerfExport");
            if (_btnApiPerfImport != null)
                _btnApiPerfImport.Text = L("ApiPerfImport");
            if (_btnApiPerfGoRecord != null)
                _btnApiPerfGoRecord.Text = L("ApiPerfGoRecord");
